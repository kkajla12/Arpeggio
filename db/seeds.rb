...
(0..4).each do |i|
  Product.create!(name: "Marshall 2x12 Speaker Cabinet",
    ...
    price: 30.00, deposit: 150, classification: "speaker", user_id: (i + 1), image: File.open("#{Rails.root}/public/uploads/marshall_cabinet.jpg"))
  Product.create!(name: "Gibson SG Cherry Finish",
    ...
    price: 65.00, deposit: 350, classification: "guitar", user_id: (i + 1), image: File.open("#{Rails.root}/public/uploads/gibson_sg.jpg"))
  Product.create!(name: "Sennheiser E835S Performance Vocal Microphone",
    ...
    price: 15.00, deposit: 50, classification: "mic", user_id: (i + 1), image: File.open("#{Rails.root}/public/uploads/sennheiser_mic.jpg"))
